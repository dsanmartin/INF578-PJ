...
\begin{document}
    ...
    %\begin{abstract}
    %	El tema del presente trabajo es la aplicación de técnicas de \emph{Machine Learning} para 
    %\end{abstract}
    ...
    \section{Introducción}
        ...
        %\subsection{Descripción del Problema}
            ...
            en términos económicos, ambientales y por poner en peligro vidas humanas. %Poder detectar, simular e idealmente
            %predecir este tipo de fenómeno se convierte en una tarea de vital importancia. \\
            Es por esto último que poder modelar estos fenómenos se convierte en una tarea de vital importancia. \\
            
            %Existen distintos enfoques para predecir los incendios, por ejemplo, mediante el uso de modelos basados en 
            %ecuaciones diferenciales o modelos estadísticos, pero la idea de este trabajo es aplicar técnicas de \emph{Aprendizaje 
            %de Máquina}. Algunos trabajos en donde se utilizan estas técnicas en variados tipos de datos pueden ser revisados 
            %en \cite{massada2013wildfire,li2004data,safi2013prediction}. \\
            
            %En la literatura es posible encontrar distintos enfoques en el modelamiento de este fenómeno. Entre los más conocidos
            %está el uso de \emph{Autómatas Celulares} que es una herramienta utilizada en el la teoría de sistemas dinámicos. Este 
            %tipo de modelos se utiliza generalmente para describir la propagación del fuego mediante el uso de reglas probabilísticas
            %\cite{malarz2002forest}
            
            %Según \cite{preisler2013forest} los modelos relacionados al comportamiento del fuego se pueden clasificar en físicos
            %\cite{albini1986wildland}, empíricos \cite{rothermel1972mathematical} o estadísticos \cite{mcmasters1973statistical}.
            %Aún así en la literatura es posible encontrar variadas referencias relacionadas con el uso de \emph{Autómatas Celulares} 
            %que es una herramienta utilizada en la teoría de sistemas dinámicos. Este tipo de modelos se utiliza generalmente 
            %para describir la propagación del fuego mediante el uso de reglas probabilísticas \cite{malarz2002forest}. \\
    ...
    \section{Desarrollo}
        ...
        \subsection{Modelos}
            ...
            \subsubsection{Random Forest}
                ...
                de los árboles se construye de forma aleatoria.%que incluye aleatoriedad al momento de definir los umbrales de división para los atributos candidatos. 
            ...
            %\subsubsection{Extremely Randomized Tree}
    ...
    \section{Conclusiones}
        ...
        TODO  
        % Luego del desarrollo del proyecto notamos que una buena estrategia para evaluar correctamente los problemas con \emph{datasets} pequeños
        % es usar \emph{Cross Validation}, de esta forma obtenemos métricas más representativas de los modelos.
        % Si bien por limitaciones de tiempo y cómputo no se realizaron más combinaciones de hiper-parámetros, si se incluyeron variadas pruebas
        % con distintas características, transformaciones y modelos, resultando como los mejores modelos para este problema: los arboles de decisión, 
        % las máquinas de soporte vectorial, el \emph{Random Forest} y su variante \emph{Extremely Randomized Tree}.
